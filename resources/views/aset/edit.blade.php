<x-app-layout>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="jenis_barang"
                                ...
                                @foreach([
                                    'Laptop','PC','Server','Router','Switch',
                                    'Access Point','Printer','Storage','Lainnya'
                                ] as $jenis)

                                    <option value="{{ $jenis }}"
                                        {{ old('jenis_barang', $aset->jenis_barang) == $jenis ? 'selected' : '' }}>
                                        {{ $jenis }}
                                    </option>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="kode_sku"
                                   value="{{ old('kode_sku', $aset->kode_sku) }}"
                                   class="w-full border rounded-lg px-3 py-2">
                        </div>
    ...
    <script>
        const lat = {{ $aset->latitude ?? -7.98 }};
        const lng = {{ $aset->longitude ?? 112.62 }};
